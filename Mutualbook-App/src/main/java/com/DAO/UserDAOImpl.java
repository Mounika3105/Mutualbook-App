...
//We'll write all the code relating add/update /delete here
public class UserDAOImpl implements UserDAO{
	...
	public User login(String email, String password) {
		...
		try
		{
			String sql="select *from user where email=? and password=?";//sql request whic asks for email and password
			PreparedStatement ps=conn.prepareStatement(sql);
